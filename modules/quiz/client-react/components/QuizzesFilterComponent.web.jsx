...
const QuizzesFilterComponent = ({
  ...
  <Form layout="inline">
    ...
    <FormItem label={t('users.list.item.role.label')}>
      <Select name="role" defaultValue={role} style={{ width: '100px' }} onChange={e => onRoleChange(e.target.value)}>
        <Option key={1} value="">
...
QuizzesFilterComponent.propTypes = {
...
export default translate('user')(QuizzesFilterComponent);
