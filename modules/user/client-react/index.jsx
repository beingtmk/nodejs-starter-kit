...
const NavLinkUsersWithI18n = translate("user")(({ t }) => (
  <NavLink to="/users" className="nav-link" activeClassName="active">
    <Icon type="user" /> {t("navLink.users")}
  </NavLink>
));
...
const NavLinkDashboardWithI18n = translate("user")(({ t }) => (
...
export default new ClientModule({
  route: [
    ...
    <AuthRoute
      ...
      redirect="/login"
      component={loadable(() =>
        import("./containers/Dashboard").then((c) => c.default)
      )}
    />,
    <AuthRoute
      exact
  ...
  navItemUser: [
    ...
    <IfLoggedIn key="/dashboard">
      <MenuItem>
        <NavLinkDashboardWithI18n />
      </MenuItem>
    </IfLoggedIn>,
