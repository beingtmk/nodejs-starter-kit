...
class CoreLayout extends React.Component {
  ...
  render() {
    const { children, navBar, type, layoutType, footerType, noNavbar } = this.props;

    return (
      <Layout id="page-layout">
        {navBar !== false && !noNavbar && (
          <NavBar isMobile={this.state.isMobile} layoutType={layoutType} />
        )}
        {__SERVER__ && __DEV__ && (
          <Helmet>
        ...
        {(!footerType || footerType === "large") && <Footer />}
      </Layout>
    );
  }
}
