...
const NavLinkMyBlogsWithI18n = translate("blog")(
...
const NavLinkBlogWithI18n = translate("blog")(
  ({ t }: { t: TranslateFunction }) => (
...
const NavLinkMyBookmarksWithI18n = translate("blog")(
  ({ t }: { t: TranslateFunction }) => (
...
const NavLinkBlogAdminWithI18n = translate("blog")(
  ({ t }: { t: TranslateFunction }) => (
    <NavLink
      to="/blog/admin-list"
      className="nav-link"
...
const NavLinkmodelAdminWithI18n = translate("blog")(
  ({ t }: { t: TranslateFunction }) => (
    <NavLink
      to="/blog/model-list"
      className="nav-link"
...
export default new ClientModule({
  route: [
    <AuthRoute
      ...
      role={["user", "admin"]}
      component={loadable(() =>
        import("./containers/NewBlog").then((c) => c.default)
      )}
    />,
    <AuthRoute
      exact
      ...
      role={["user", "admin"]}
      component={loadable(() =>
        import("./containers/EditBlog").then((c) => c.default)
      )}
    />,
    <AuthRoute
      exact
    ...
    <AuthRoute
      ...
      role={["user", "admin"]}
      component={loadable(() =>
        import("@gqlapp/bookmark-client-react/containers/BlogBookMarks").then(
          (c) => c.default
        )
      )}
    />,
    <Route
      ...
      path="/blog/list"
      component={loadable(() =>
        import("./containers/BlogList").then((c) => c.default)
      )}
    />,
    <AuthRoute
      exact
      ...
      role={["admin"]}
      component={loadable(() =>
        import("./containers/AdminBlogs").then((c) => c.default)
      )}
    />,
    <AuthRoute
      exact
      ...
      role={["admin"]}
      component={loadable(() =>
        import("./containers/AdminModelsList").then((c) => c.default)
      )}
    />,
    // <Route
    //   exact
